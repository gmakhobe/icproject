 ...
 <div id="pattern" class="pattern">
  	<div class="c">
            ...
            <div class="ex-1 example">
                <ul>
                    <li><i class="fa fa-desktop"></i><span>Management</span></li>
                    <li class="active"><i class="fa fa-newspaper-o"></i><span>News</span></li>
                    <li><i class="fa fa-cubes"></i><span>Specification</span></li>
                    <li><i class="fa fa-server"></i><span>stock</span></li>
                    <li><i class="fa fa-line-chart"></i><span>analyze</span></li>
            ...
            <nav class="Navi">
            <ul>
                <li><a href="">MARKET RESPONSE</a></li>
                <li><a href="">COMPANY POLICY</a></li>
                <li><a href="">COMPANY RECORDS</a></li>
