 ...
 <div class="main-wrapper">
  ...
  <select name="assess" class="assess">
    ...
    <div class="book-types">
     ...
     <a href="#" id="Schoolsid" class="book-type"> Schools</a>
     <a href="#" id="MyClassesid" class="book-type"> My Classes</a>
     <a href="#" id="HowToUseICid" class="book-type"> How to use IC</a>
    </div>
   </div>
   ...
   <script>
          ...
          $(document).ready(function(){
            ...
            $("#InvestingStrategiesid").click(function(){
              $("#allLessons").hide();
                $("#Testimonies").hide();
                  $("#Schools").hide();
                    $("#MyClasses").hide();
